...
export default class UserStore {
  ...
  constructor() {
    autorun(() => {
      const token = this.user && this.user.token && this.user.token.data;
      apis.authorization(token);
      serverApis.isConnected() && serverApis.authorization(token);
    });
  }
